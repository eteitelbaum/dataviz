...
## Step 1: A line chart over time (35 pts)
...
## Step 2: A bar chart comparing regions (20 pts)
...
*b) Make a bar chart with `geom_col()`, putting `region` on the x-axis and your summarized democracy measure on the y-axis. Add labels and a title.*

::: {.callout-note appearance="simple"}
## Keep it consistent
From here on, every chart you make should get the same treatment you gave your line chart: a theme, and a colorblind-safe palette wherever you map a color. If you map `fill = region` here, reach for `scale_fill_viridis_d()`---the fill counterpart to the `scale_color_viridis_d()` you used in Step 1.
:::
