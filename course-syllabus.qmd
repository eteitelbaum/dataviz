...
-   **Module quizzes**: No AI. These check your own understanding, and you should complete them on your own.

-   **Coding assignments**: AI is welcome as a *consultant* once you have tried the course materials and are genuinely stuck. You must understand and be able to explain every line you submit. Include a one-line note describing what tool you used and how.

-   **Final project**: AI is encouraged as a real-world tool for debugging and boilerplate. The design, data choices, analysis, and interpretation, however, must be your own---that is the work the project is meant to demonstrate.
