...
Location: Hall of Government, Rm 102

Meeting times: Tuesdays and Thursdays, 11:10 a.m. -- 12:25 p.m.
...
This course exists so that *you* develop genuine skill in R and data visualization. AI coding assistants---such as ChatGPT, Claude, Gemini, Copilot, and IDE-integrated tools like Cursor---are now a real part of data-science practice, and you are welcome to use them. But *how* and *when* you use them determines whether you actually learn. There is an important distinction between using AI as a learning support and using it to replace learning entirely. Submitting AI-generated work as your own defeats the purpose of the course.

### The four principles

Follow these principles whenever you use AI tools:
...
### What this means by assessment type

-   **Quizzes**: No AI. Quizzes check your own understanding, and you complete them on your own during class.

-   **In-class labs**: You work in groups during class. You may use AI to **ask conceptual questions or to help debug**, but **not to write your code for you**---the goal is for your group to reason through the problem together. Add a one-line note to each lab saying whether and how you used AI.

-   **Final project**: A full, modern AI-assisted workflow is encouraged---AI is a real tool that data scientists use every day. The design, data choices, analysis, and interpretation must still be your own, and you should be able to explain and defend everything in your app.
...
We draw on two excellent, freely available online books. There is nothing to purchase.

-   **Kieran Healy, [*Data Visualization: A Practical Introduction*](https://socviz.co/)** --- our main text for the visualization side of the course. Chapter readings are listed on the [course schedule](/index.qmd).
-   **Wickham, Çetinkaya-Rundel & Grolemund, [*R for Data Science* (2nd ed.)](https://r4ds.hadley.nz/)** --- our reference for importing, tidying, and transforming data.

## Course Credit Hour Policy

This is a 3-credit course. Following the university credit-hour policy, over the roughly 15-week semester you should expect approximately 2.5 hours of direct instruction per week (our Tuesday and Thursday class meetings) and a minimum of 5 hours per week of independent work---including readings, quizzes, lab preparation, and your final project. Over the term this amounts to about 37.5 hours of direct instruction and 75 hours of independent coursework.
...
-   **In-class labs:** Most weeks you will work through a hands-on lab with your group during class. Labs let you apply new skills to real data while you have your classmates and me on hand to help.

-   **Quizzes:** Short in-class quizzes give you---and me---a quick read on how well the week's material and readings are landing. They provide immediate feedback and support ongoing learning.

-   **Final Project:** You will design and build your own interactive Shiny app, or write a polished report built around a well-crafted visualization, as your final project. Either way, it's developed over the second half of the semester and presented in class during our final session.
...
Because your labs and quizzes are completed in class, a large share of your grade rewards showing up and engaging with the material in person.

### In-class labs

You will complete four hands-on labs---on **plotting**, **wrangling**, **maps**, and **tables and models**---worked through with your group during class and meant to be mostly finished in the class period. Labs are where you apply new skills to real data. See the [Policy on AI Tools](#policy-on-ai-tools) for how AI may be used in labs.

### Quizzes

You will complete short in-class quizzes on the week's readings and core concepts. Because they check your own understanding, quizzes are completed individually and without AI. I will drop your two lowest quiz scores; please do not email me about missed quizzes.

### Final Project

You will design and build an interactive R Shiny app, or write a report built around a well-crafted visualization---your choice of track---developed over the second half of the semester during our in-class project studios and presented to the class at the end of the term. You may work on your own or in a **group of up to three**, with a clear division of responsibilities. Full details, including the group policy, are on the [Project Description](/project/project-description.qmd) page.
