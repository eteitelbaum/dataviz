...
-   **Final Project:** You will design and build your own interactive data visualization application (a Shiny app) as your final project, developed over the second half of the semester and presented in class during our final session.
...
You will design and build an interactive R Shiny app, developed over the second half of the semester during our in-class project studios and presented to the class at the end of the term. You may work on your own or in a **group of up to three**, with a clear division of responsibilities. Full details, including the group policy, are on the [Project Description](/project/project-description.qmd) page.
