...
## Colorblind-Safe Palettes {.smaller}
...
- **ColorBrewer** -- also built in, but only *some* of its palettes are safe; use the [selector tool](https://colorbrewer2.org/) and check the "colorblind safe" box
- **[paletteer](https://emilhvitfeldt.github.io/paletteer/)** -- thousands of palettes through one function, including the classic **Okabe-Ito** set
...
- Then build your own: paste in the Okabe-Ito codes and change one [hex code](https://htmlcolorcodes.com/). Does it still pass?
