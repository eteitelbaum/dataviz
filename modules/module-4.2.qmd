---
title: "Models & Coefficient Plots"
...
**Packages:** `peacesciencer`, `broom`, `dplyr`, `modelsummary`

**Functions:** `create_stateyears()`, `add_ucdp_acd()`, `add_democracy()`, `tidy()`, `mutate_if()`, `glm()`, `binomial()`, `list()`, `modelsummary()`, `modelplot()`, `rev()`
:::
