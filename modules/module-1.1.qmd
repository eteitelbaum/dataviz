...
**Functions:** `read_csv()`, `glimpse()`, `pivot_longer()`, `mutate()`, `mutate_at()`, `substring()`
:::

::: {.callout-tip}
## Prework

- Install R, R Studio and the Tidyverse collection of packages if you have not done so already (see [R and RStudio Setup](/modules/getting-started-1.html))
