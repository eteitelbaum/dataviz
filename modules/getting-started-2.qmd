...
- **Links**: `[link text](url)` — for example `[Quarto](https://quarto.org/)` becomes [Quarto](https://quarto.org/).
...
Try editing some text in your Quarto document using these elements, then switch between the Source and Visual editors to see how each one is represented in the other. When you're ready to see everything Markdown can do, have a look at this [Markdown guide](https://www.markdownguide.org/basic-syntax/) and this [cheat sheet](https://www.markdownguide.org/cheat-sheet/) for quick reference.
